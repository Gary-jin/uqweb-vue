  ...
  <div class="newactivities">
    ...
    <div class="share_to" v-transfer-dom>
      ...
      <div class="classBox"  v-if="showToast ===true"  >
        ...
        <div><img src="../../assets/img/home/goods/qq.png" alt="" @click="shareFri(3)"><p>QQ</p></div>
        <div><img src="../../assets/img/home/goods/shares.png" alt="" @click="shareFri(4)"><p>复制链接</p></div>
      </div>
    </div>
    ...
    getSwiper () {
      ...
      this.$http.post('/amoy/user/invite-poster', {}, true, true).then(res => {
        if (res.code === 0) {
          ...
          this.shareurl = res.data.downloadUrl
        }
      })
    }
  },
