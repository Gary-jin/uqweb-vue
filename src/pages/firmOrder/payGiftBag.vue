<template>
  <div id="payGiftBag" class="payGiftBag" >
    ...
    <div class="buyBox">
      <div class="buyBtn" @click="pay()" :style="{background: 'linear-gradient('+$store.state.global.theme.deg+'deg,' +$store.state.global.theme.mainColor+','+$store.state.global.theme.secondColor+')'}">立即购买</div>
    </div>
  </div>
</template>
