    ...
    <div class="seller">
      <div class="mescrollBox">
        <mescroll-vue ref="mescroll"  :down="mescrollDown" :up="mescrollUp" @init="mescrollInit">
          <div class="seller-head" :style="{'background-image':slides ? 'url('+slides+')' :'url(./static/libs/img/sjbj.png)',paddingTop: statusH + 'rem'}" ref="mate">
          ...
          <div  ref="tabBox" class="tabBox" :style="{paddingTop: isShowH ? h + 'px' : '0px'}">
          ...
          <List :list="list" :style="{paddingTop:pt}"></List>
          <div id="empty"></div>
        </mescroll-vue>
      </div>
      <!--显示二维码-->
...
export default {
  ...
  methods: {
    ...
    search () {
      ...
      this.jumpTo('/mall/productList?spid=' + this.$route.query.spid + '&keyword=' + this.searchText)
    ...
    handleScroll (mescroll, y, isUp) {
      let that = this
      let ptop = that.$refs.tabBox.offsetHeight
