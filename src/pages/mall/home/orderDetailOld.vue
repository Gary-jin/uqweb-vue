        ...
        <div>
          <div class="content_main">
            <div class="list">
              ...
              <div class="mail" v-for="(item,index) in obj.goodsList" :key="index" @click="jumpTo('/mall/homeDetail?title='+item.goodsId)">
                <div class="left">
              ...
              <div class="li_main" v-if="obj.order.orderStatus > 0" @click="jumpTo('/mall/logistics?orderSn=' + obj.order.orderSn)">
          ...
          <div class="content_main" style="margin-top:0.1rem;">
            <div class="list">
              ...
              <div class="refund">
                <div class="btns btn1s" v-if="payStatus === '1' && (obj.order.orderStatus === '1' || obj.order.orderStatus === '0')" @click="jumpTo('/mall/exchange?orderSn='+obj.order.orderSn)">申请退货</div>
