      ...
      <div class="mescrollBox">
        <mescroll-vue ref="mescroll" :down="mescrollDown" :up="mescrollUp" @init="mescrollInit">
          <div v-if="isShow" id="d1">
            <Business :list="suggest" :businessComponentType="'collect'" @jump="seller" @f5="f5"></Business>
          </div>
        </mescroll-vue>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    seller (id) {
      ...
      dsBridge.call("open", {url: window.location.origin +'/uqWeb/html/mall/mallShop.html?spid=' + id,type: 'web'})
    },
    selectItem (type) {
