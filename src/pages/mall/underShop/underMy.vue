<template>
  <div class="under-my" v-if="isShow">
    ...
    <div class="address1" @click="jumpTo('/mall/shopCenter')" v-show="shopInfo && shopInfo.status == 1 && info.isShop > 0">
      <div>
    ...
    <div class="address1" @click="jumpTo('/mall/applyShop')" v-show="info.isShop <= 0">
      <div>
    ...
    <div class="address1" @click="jumpTo('/mall/myCoupon')">
      <div>
    ...
    <div class="address1" @click="jumpTo('/mall/myClub')">
      <div>
    ...
    <div class="address1" @click="jumpTo('/mall/underOrderList')">
      <div>
    ...
    <div class="address1" @click="jumpTo('/mall/underGoodsList')">
      <div>
    ...
    <div class="address1" @click="jumpTo('/mall/distributor')" v-show="!isDisUser && disUserInfo.type == 3">
      <div>
        <img src="../../../assets/mall/img/my/shangjia.png" alt="">
    ...
    <div class="address1" @click="jumpTo('/mall/grade')" v-show="(isDisUser && isDisUser.status === '1') || disUserInfo.type == 0">
      <div>
