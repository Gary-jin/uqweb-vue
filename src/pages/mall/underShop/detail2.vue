    ...
    <div class="under_detail" v-if="isShow">
      ...
      <div class="mescrollBox">
        <div class="under-body">
          ...
          <div class="detail-huiyuan" style="margin-top: .05rem;" @click="jumpTo('/mall/underShopInfo?spid='+ shopInfo.id)">
          ...
          <div class="detail-youhuijuan" @click="jumpTo('/mall/drawYhj?spid='+ shopInfo.id)" v-if="couponList">
          ...
          <div class="detail-huiyuan" @click="jumpTo('/mall/myCoupon?spid='+ shopInfo.id)">
          ...
          <div class="detail-huiyuan" @click="jumpTo('/mall/hykCenter?spid='+shopInfo.id)" v-if="userCard">
            <img src="../../../assets/mall/img/under/card.png" alt="">
          ...
          <div class="detail-huiyuan" @click="jumpTo('/mall/underOrderList?spid='+shopInfo.id)">
      ...
      <div class="goPay" :style="{paddingBottom: bot + 'px'}">
        <!--<div>-->
        <!--<img :src="'./static/libs/img/jinggao.png'" alt="">-->
        <!--<span class="jubao">举报商家</span>-->
        <!--</div>-->
        <div @click="jumpTo('/mall/payUnder?spid='+shopInfo.id)" v-if="shopInfo.isHoursStop == 0">
          <span>我要买单</span>
        </div>
