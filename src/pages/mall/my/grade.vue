  ...
  <div class="link">
    ...
    <div class="link-body" v-if="showInfo">
      ...
      <div class="link-two">
        ...
        <div class="address1" @click="jumpTo('/mall/myTeam')">
          <div>
        ...
        <div class="address1" @click="jumpTo('/mall/exploitShop')" v-if="info.otoUserType && $isMallUnderShop">
          <div>
        ...
        <div class="address1" @click="jumpTo('/mall/myCity')" v-if="info.cityInfo && $isMallUnderShop">
          <div>
        ...
        <div class="address1" @click="jumpTos({'link': agentLink, 'types': 'noTitleHttpUrl'})" v-if="info.cityInfo && $isMallUnderShop">
          <div>
            <img src="../../../assets/mall/img/my/zu.png" alt="">
            <p>省市县代理</p>
          </div>
          <img src="../../../assets/mall/img/my/left.png" alt="">
        </div>
  ...
  export default {
    data () {
      return {
        ...
        agentInfo: {},
        showInfo: false,
        agentLink: window.location.origin + '/uqWeb/html/agent_profit_detail/index.html'
      }
    },
    mounted () {
  ...
  .link{
    .link-body{
      ...
      .link-one{
        ...
        padding: 0 .3rem;
        margin-bottom: .2rem;
        background: url(../../../assets/mall/img/my/beijing.png) no-repeat;
