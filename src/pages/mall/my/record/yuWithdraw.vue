  ...
  <div class="payMent yuWithdraw">
    <div class="header">
      ...
      >
        ...
        <a slot="right" @click="jumpTo('/mall/withdrawList?type=' + 'user')">记录</a>
      </x-header>
    </div>
...
export default {
  ...
  methods: {
    ...
    handShow () {
      ...
      if (this.data.withdrawType.bankCard.cardInfo && this.data.withdrawType.bankCard.cardInfo.bankCard) {
        this.bankCard = this.data.withdrawType.bankCard.cardInfo.bankCard
      }
      if (this.data.withdrawType.bankCard.cardInfo && this.data.withdrawType.bankCard.cardInfo.bankName) {
        this.bankName = this.data.withdrawType.bankCard.cardInfo.bankName
      }
      if (this.data.withdrawType.bankCard.cardInfo && this.data.withdrawType.bankCard.cardInfo.bankNameNo) {
