...
// 商品分类
export const goodsCate = function () {
  return http.post(mall + '/index/goods-cate')
}
// 商品列表
export const indexList = function (cid, page) {
  return http.post(mall + '/index/goods-list', {cid, page})
}
// 猜你喜欢
export const indexLikeList = function (isLike, page) {
  return http.post(mall + '/index/goods-list', {isLike, page})
}
// 商品列表--订单详情
...
// 商品列表
export const goodsDetail = function (goodsId, version) {
  return http.post(mall + '/index/goods-detail', {goodsId, version}, true)
}

// 商品收藏
export const goodsLike = function (goodsId, version) {
  return http.post(mall + '/users/goods-like', {goodsId, version})
}
// 新商品收藏
export const newGoodsLike = function (status, goodsId, model) {
  return http.post('/amoy_v2/user/goods-like', {status, goodsId, model})
}
// 商家收藏
...
// 商家收藏
export const goodLickList = function (version) {
  return http.post(mall + '/users/goods-like-list', {version})
}
// 搜索列表
export const search = function (type, model) {
  return http.post(mall + '/index/search', {type: type, model}, true)
}
export const searchStore = function (type, model) {
  return http.post(mall + '/index/search', {type: type, model}, true)
}
// 搜索列表
...
// 地址列表
export const addressList = function (page) {
  return http.post(mall + '/users/address-list', {page})
}
// 地址设为默认
...
// 商家搜索
// 删除收藏
export const goodsLikeDelete = function (likeIds, version) {
  return http.post(mall + '/users/goods-like-delete', {likeIds, version})
}
// 商品足记类表
...
// 查询订单
export const cardCheckout = function (type, goodsInfo, couponId) {
  return http.post(mall + '/cart/checkout', {type, goodsInfo, couponId}, true)
}
// 添加购物车
...
// 创建订单
export const orderCreate = function (goodsInfo, note, deduceType, couponId) {
  return http.post(mall + '/order/create', {goodsInfo, note, deduceType, couponId}, true)
}
// 订单记录
...
// 支付信息
export const paymentPayType = function (orderId, payType, password, version) {
  return http.post(mall + '/payment/display', {orderId, payType, password, version}, true)
}
// 退货
...
// 用户提现记录
export const userwithdrawList = function (page) {
...
// 积分转佣金 -- 记录
export const jifenYongjinList = function (page) {
  return http.post(mall + '/credit/credit-change-list', {page: page, credittype: 'credit3'})
}
// 积分转余额--提交
export const jifenYueSub = function (type, price) {
  return http.post(mall + '/credit/credit-change', {type: type, price: price, credittype: 'credit1'}, true, true)
}
// 佣金信息
...
export const donationSub = function (credittype, type, uid, price) {
  return http.post(mall + '/credit/credit-attorn', {credittype: credittype, type: type, uid: uid, price: price}, true, true)
}
// 转赠--记录
...
export const underIndex = function () {
  return http.post(mall + '/oto/display', {}, true, true)
}
// 线下商城--商家详情
...
// 线下商城-- 支付信息
export const underPaymentPayType = function (orderId, couponTypes, couponId, couponNum, payType, password, version) {
  return http.post(mall + '/payment/display', {orderId: orderId, couponTypes: couponTypes, couponId: couponId, couponNum: couponNum, payType: payType, password, version}, true)
}
// 线下商城-- 领取优惠券
...
// 线下商城-- 商品详情
export const underShopGoodsDetails = function (goodsId, goodsNum, message, attrId, couponId) {
  return http.post(mall + '/oto/goods-detail', {goodsId: goodsId, goodsNum: goodsNum, message: message, attrId: attrId, couponId: couponId}, true, true)
}
// 线下商城-- 商品下单
export const underShopGoodBuy = function (model, goodsInfo, note, deduce, wayType, couponId, deduceType) {
  return http.post(mall + '/order/create', {model: model, goodsInfo: goodsInfo, note: note, deduce: deduce, wayType: wayType, couponId: couponId, deduceType: deduceType}, true)
}
// 线下商城-- 商品订单
